...
export class Workspace {
  ...
  async setup() {
    ...
    const ident = this.manifest.name ? this.manifest.name : structUtils.makeIdent(null, `${this.computeCandidateName()}-${hashUtils.makeHashFrom<string>(this.relativeCwd).substring(0, 6)}`);
